...
public class DecksConstructor {
	...
	/**
	 * 
	 * @return the shuffled chances deck
	 */
	public static Deck chancesDeck() {
		...
		d.addCard(new GoToNoStartBonus(10, "Andate in prigione direttamente, senza passare dal \"VIA!\""));
	...
	/**
	 * 
	 * @return the shuffled accidents deck
	 */
